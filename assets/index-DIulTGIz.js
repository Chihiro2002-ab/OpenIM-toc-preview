const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/OpenIMApp-CWHboOiy.js","assets/OpenIMApp-BY7xa1oc.css"])))=>i.map(i=>d[i]);
...
`};window.mountOpenIMIcons=(t=document,n={})=>{let r=n.aliases||{},i=new Set(n.flipped||[]);t.querySelectorAll(`[data-openim-icon]`).forEach(t=>{let n=t.dataset.openimIcon,a=r[n]||n,o=e[a];if(!o){console.warn(`Missing OpenIM icon: ${n} -> ${a}`);return}if(t.matches(`svg.openim-icon`)&&t.dataset.openimResolved===a){t.classList.toggle(`is-flipped`,i.has(n));return}let s=document.createElement(`template`);s.innerHTML=o.trim();let c=s.content.firstElementChild,l=[...t.classList].filter(e=>e!==`openim-icon`&&e!==`is-flipped`);c.classList.add(`openim-icon`,...l),c.classList.toggle(`is-flipped`,i.has(n)),c.dataset.openimIcon=n,c.dataset.openimResolved=a,c.setAttribute(`aria-hidden`,`true`),c.setAttribute(`focusable`,`false`),t.replaceWith(c)})}})(),(0,S.createRoot)(document.querySelector(`#root`)).render((0,C.jsx)(ae,{}));export{c as a,o as i,x as n,d as o,h as r,u as s,w as t};